...
let movieList = [] //array que contiene la lista de peliculas buscadas

//Funcion para mostrar la informacion de las peliculas al hace click en ellas.
function showMovieInfo(movieId) {
  let body = document.getElementById("body");

  let movie = movieList.find((movie) => movie.id == movieId);

  // Buscamos todos los elementos con la clase offcanvas y los eliminamos para arreglar el bug de que se abren varios offcanvas en el DOM al
  // hacer click en las tarjetas de las películas
  ...
  // Activa el componente offcanvas de boostrap
